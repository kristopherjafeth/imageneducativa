                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                             ...
                             <div class="float-right">
                                <a href="{{ route('carpetas.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('CREAR NUEVO') }}
                                </a>
                              </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('carpetas.destroy',$carpeta->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('carpetas.show',$carpeta->id) }}"><i class="fa fa-fw fa-eye"></i></a>
