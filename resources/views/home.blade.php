                                    ...
                                    <div class="card bg-c-blue order-card">
                                        <div class="card-block">
                                                ...
                                                <h2 class="text-right"><i
                                                        class="fa fa-users f-left"></i><span>{{ $cant_usuarios }}</span>
                                                </h2>
                                    ...
                                    <div class="card bg-c-green order-card">
                                        <div class="card-block">
                                            <a href="/productos">
                                                ...
                                                @endphp
                                                <h2 class="text-right" style="text-decoration: none;  color: #fff!important;"><i
                                                        class="fa fa-box f-left" style="text-decoration: none; color: #fff!important;"></i><span>{{ $cant_roles }}</span></h2>
                                ...
                                <div class="col-lg-3 col-xs-12">
                                    <div class="card naranja  order-card">
                                        <div class="card-block">
                                            ...
                                            @endphp
                                            <h2 class="text-right"><i
                                                    class="fa-solid fas fa-shopping-cart f-left"></i></i><span>{{ $cant_blogs }}</span>
                                            </h2>
                                ...
                                <div class="col-lg-3 col-xs-12">
                                    <div class="card morado  order-card">
                                        <div class="card-block">
                                            ...
                                            @endphp
                                            <h2 class="text-right"><i
                                                    class="fa-solid fas fa-folder f-left"></i></i><span>{{ $cant_blogs }}</span>
                                            </h2>
                                ...
                                <div class="col-lg-3 col-xs-12">
                                    <div class="card rojo  order-card">
                                        <div class="card-block">
                                            ...
                                            @endphp
                                            <h2 class="text-right"><i
                                                    class="fa-solid fas fa-file f-left"></i></i><span>{{ $cant_blogs }}</span>
                                            </h2>
                                            <p class="m-b-0 text-right"><a href="/pedidos" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                ...
                                <div class="col-lg-3 col-xs-12">
                                    <div class="card verde  order-card">
                                        <div class="card-block">
                                            ...
                                            @endphp
                                            <h2 class="text-right"><i
                                                    class="fa-solid fas fa-check f-left"></i></i><span>{{ $cant_blogs }}</span>
                                            </h2>
                                            <p class="m-b-0 text-right"><a href="/pedidos" class="text-white">Ver más</a>
                                            </p>
                                        </div>
                                ...
                                <div class="col-lg-3 col-xs-12">
                                    <div class="card negro  order-card">
                                        <div class="card-block">
                                            ...
                                            @endphp
                                            <h2 class="text-right"><i
                                                    class="fa-solid fas fa-times-circle f-left"></i></i><span>{{ $cant_blogs }}</span>
                                            </h2>
                                            <p class="m-b-0 text-right"><a href="/pedidos" class="text-white">Ver más</a>
                                            </p>
                                        </div>
